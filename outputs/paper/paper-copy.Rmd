...
```{r 2019-results-med-arxiv, out.width="75%", fig.align='center', fig.cap = "Number of pre-prints posted per month to arXiv and bioRxiv in 2019"}
...
bio_arxiv_2019 <- rbind(bio_2019, arxiv_2019)
...
bio_arxiv_2019 %>% 
  ...
  labs(title = "Pre-prints posted per month, 2019",
       subtitle = "Total of 150,018 pre-prints on arXiv and 31,752 on bioRxiv",
       x = "Month",
       y = "Number of pre-prints",
       fill = "Repository") +
  theme_minimal() +
...
```{r 2019-results-med-sociarxiv, out.width="75%", fig.align='center', fig.cap = "Number of pre-prints posted per month to medRxiv and socArXiv in 2019"}
med_socarxiv_2019 <- rbind(med_2019, socarxiv_2019)
...
med_socarxiv_2019 %>% 
  ...
  geom_histogram(stat="count", position = "dodge2") +
  labs(title = "Pre-prints posted per month, 2019",
       subtitle = "Total of 913 pre-prints on medRxiv and 1,614 on socArXiv",
       x = "Month",
       y = "Number of pre-prints",
       fill = "Repository") +
  theme_minimal() +
